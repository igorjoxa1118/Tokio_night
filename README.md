...
В случае, если вам не нужны изменения в своей конфигураци i3, тогда файлии(мои) $$ $${\color{red}'config' \space 'keybinds \space 'window_rules' \space 'start_progs' \space }$$
 и папку $${\color{red}bin}$$ закидывать не нужно.
